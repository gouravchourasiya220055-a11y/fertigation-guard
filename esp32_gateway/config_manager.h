...
extern Preferences backupPrefs;
...
inline void factoryReset() {
    ...
    snprintf(sysConfig.deviceId, sizeof(sysConfig.deviceId), "GATEWAY01");
    snprintf(sysConfig.nodeName, sizeof(sysConfig.nodeName), "FertigationGateway");
...
inline void loadFromPrefs(Preferences& p) {
    ...
    String str;
    str = p.getString("devId", "GATEWAY01"); snprintf(sysConfig.deviceId, sizeof(sysConfig.deviceId), "%s", str.c_str());
    str = p.getString("nodeName", "FertigationGateway"); snprintf(sysConfig.nodeName, sizeof(sysConfig.nodeName), "%s", str.c_str());
...
inline void printConfiguration() {
    ...
    Serial.print("WiFi SSID : "); Serial.println(sysConfig.wifiSsid);
    Serial.print("Backend   : "); Serial.println(sysConfig.backendUrl);
